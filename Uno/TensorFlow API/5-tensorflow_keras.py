...
# Split the test data into validation & actual test data(prevents overfitting)
split = 8000
...
# Create class names & normalize the arrays
class_names = ['T-shirt/top', 'Trouser', 'Pullover', 'Dress', 'Coat', 'Sandal', 'Shirt', 'Sneaker', 'Bag', 'Ankle boot']
train_images, test_images, validation_images = train_images / 255.0, test_images / 255.0, validation_images / 255.0
print(train_images.shape) # the image is just a numpy array of images; each image is 28 x 28
